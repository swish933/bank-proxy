...
async function renderPDF(html) {
	...
	try {
		...
		const blockAssets = (req) => {
			...
			// Allow data: URIs through (your embedded base64 fonts live here)
		...
		// Small settle delay for any synchronous rendering
...
//       pipe: false,     // Kept false as pipe fails on Windows
//       timeout: 30000,  // 30 seconds max to launch
//       args: [
//         "--no-sandbox",
//         "--disable-setuid-sandbox",
//         "--disable-dev-shm-usage",
...
//     browserInstance.on("disconnected", () => {
//       logger.warn("Chrome disconnected — cleaning up instance pointer");
//       browserInstance = null;
//     });
//   }
...
//   try {
//     // Intercept requests to save bandwidth/speed
//     await page.setRequestInterception(true);
//     // page.on("request", (req) => {
...
//         }
//       } catch (err) {
//         // Force a continue if something unexpected happens to prevent hanging
//         logger.error({ err }, "Interception failed, forcing continue");
//         req.continue();
//       }
//     });

//     // Combined timeout handling to prevent silent hanging
//     await page.setContent(html, {
//       waitUntil: "domcontentloaded",
//       timeout: 30000,
//     });

//     // Small settle delay for layout calculation
...
//   } catch (error) {
//     logger.error({ error }, "Error during page rendering steps");
//     throw error;
//   } finally {
//     try {
//       await page.close();
