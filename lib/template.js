...
// 	let p1Sections = compileBlock("1.1 Personal Details", [
// 		{ label: "Account Category", value: formState.acct_category },
// 		{ label: "Full Name", value: primaryName },
// 		{ label: "Gender", value: formState.gender },
// 		{ label: "Date of Birth", value: formState.dob },
// 		{ label: "Religion", value: formState.religion },
// 		{ label: "Place of Birth", value: formState.place_of_birth },
// 		{ label: "Marital Status", value: formState.marital },
// 		{ label: "State of Origin", value: formState.state_of_origin },
// 		{ label: "LGA", value: formState.lga },
// 		{ label: "Mother's Maiden Name", value: formState.mothers_maiden_name },
// 	]);

// 	p1Sections += compileBlock("1.2 Contact & Address", [
// 		{ label: "Email Address", value: formState.email },
// 		{ label: "CHN", value: formState.existing_chn },
// 		{
// 			label: "Mobile Number",
// 			value: `(${formState.mobile_country_code || ""}${formState.mobile_city_code || ""}) ${formState.mobile || ""}`,
// 		},
...
// 		{ label: "Resident?", value: formState.residence_ind },
// 		{ label: "Date of Entry", value: formState.date_of_entry },
// 		{ label: "Other Passport?", value: formState.other_passport },
// 		{
...
// 	let p2Sections = compileBlock("2.1 Identification", [
// 		{ label: "ID Type", value: formState.id_type },
// 		{ label: "ID Number", value: formState.id_number },
// 		{ label: "ID Issue Date", value: formState.id_issue_date },
// 		{ label: "ID Expiry Date", value: formState.id_expiry_date },
// 		{ label: "ID Place of Issue", value: formState.id_place_of_issue },
// 		{ label: "Online Access?", value: formState.online_access },
// 		{
...
// 	p2Sections += compileBlock("2.2 Employment & Financial Details", [
// 		{
...
// 					: formState.emp_status,
// 		},
// 		{ label: "Occupation", value: formState.occupation },
// 		{ label: "Employment Sector", value: formState.emp_segment },
// 		{ label: "Job Title", value: formState.job_title },
// 		{ label: "Years Employed", value: formState.years_employed },
// 		{ label: "Company Name", value: formState.company_name },
// 		{
// 			label: "Office Phone",
// 			value: `(${formState.office_phone_country_code || ""}${formState.office_phone_city_code || ""}) ${formState.office_phone || ""}`,
// 		},
// 		{ label: "WhatsApp Number", value: formState.whatsapp_number },
// 		{ label: "Office Email", value: formState.office_email },
// 		{ label: "Annual Income", value: formState.income },
// 		{ label: "Source of Funds", value: formState.funds_source },
// 		{ label: "Investment Purpose", value: formState.invest_purpose },
// 		{ label: "Referral", value: formState.referral },
// 		{
...
// 			},
// 		]);
// 		pJointSections += compileBlock("3.2 Employment & Identification", [
// 			{
// 				label: "Educational Qualification",
// 				value: j.educational_qualification,
// 			},
// 			{ label: "Employment Status", value: j.emp_status },
// 			{ label: "Occupation", value: j.occupation },
// 			{ label: "Job Title", value: j.job_title },
// 			{ label: "Company Name", value: j.company_name },
// 			{
// 				label: "Office Phone",
// 				value: `(${j.office_phone_country_code || ""}${j.office_phone_city_code || ""}) ${j.office_phone || ""}`,
// 			},
// 			{ label: "Office Email", value: j.office_email },
// 			{ label: "Annual Income", value: j.income },
// 			{ label: "Source of Funds", value: j.funds_source },
// 			{ label: "ID Type", value: j.id_type },
// 			{ label: "ID Number", value: j.id_number },
// 			{ label: "ID Issue Date", value: j.id_issue_date },
// 			{ label: "ID Expiry Date", value: j.id_expiry_date },
// 			{ label: "ID Place of Issue", value: j.id_place_of_issue },
// 			{ label: "Residential Address", value: j.res_address, fullWidth: true },
// 			{ label: "Mailing Address", value: j.mailing_address, fullWidth: true },
// 			{ label: "Company Address", value: j.company_address, fullWidth: true },
// 		]);
// 		page3 = createPageHTML(
...
// 	const bankPageNum = 3 + jointPageOffset;
// 	let p3Sections = compileBlock("4.1 Bank Details", [
...
// 		{ label: "Account Number", value: formState.acct_number },
// 		{ label: "BVN", value: formState.bvn },
// 		{ label: "Date Account Opened", value: formState.bank_opened_date },
// 	]);

// 	if (formState.nok1) {
// 		const n1 = formState.nok1;
// 		p3Sections += compileBlock("4.2 Next of Kin (Primary)", [
// 			{
// 				label: "Full Name",
// 				value:
// 					`${n1.title || ""} ${n1.first_name || ""} ${n1.middle_name || ""} ${n1.last_name || ""}`.trim(),
...
// 				value: `(${n1.tel_country_code || ""}${n1.tel_city_code || ""}) ${n1.tel || ""}`,
// 			},
// 			{ label: "Address", value: n1.address, fullWidth: true },
// 		]);
// 	}

// 	if (formState.nok2 && formState.nok2.first_name) {
// 		const n2 = formState.nok2;
// 		p3Sections += compileBlock("4.3 Next of Kin (Secondary)", [
// 			{
// 				label: "Full Name",
// 				value:
// 					`${n2.title || ""} ${n2.first_name || ""} ${n2.middle_name || ""} ${n2.last_name || ""}`.trim(),
...
// 				value: `(${n2.tel_country_code || ""}${n2.tel_city_code || ""}) ${n2.tel || ""}`,
// 			},
// 			{ label: "Address", value: n2.address, fullWidth: true },
// 		]);
// 	}

// 	let page4 = createPageHTML(
// 		"Bank Details & Next of Kin",
// 		"Settlement Account & Beneficiaries",
// 		p3Sections,
// 		bankPageNum,
// 		totalDocumentPages,
// 	);
...
// 	// ── Page 5: Compliance ────────────────────────────────────────────────────
// 	const compliancePageNum = 4 + jointPageOffset;
// 	let p4Sections = compileBlock("5.1 Minor Account", [
...
// 		},
// 		{
// 			label: "Minor's Gender",
// 			value: includesMinor ? formState.minor?.gender : "N/A",
// 		},
// 		{
// 			label: "Guardian's Relationship to Minor",
// 			value: includesMinor ? formState.minor?.relationship : "N/A",
// 		},
// 	]);

// 	const politicalArray = [
// 		{ label: "Is Applicant a PEP?", value: formState.political },
// 		{
...
// 				formState.political === "Yes" ? formState.political_date_to : "N/A",
// 		},
// 		{ label: "Related to a PEP?", value: formState.rel_political },
// 	];
// 	if (formState.rel_political === "Yes") {
// 		if (formState.rel_political_1?.name) {
// 			politicalArray.push({
// 				label: "Related PEP 1 — Name & Relationship",
// 				value: `${formState.rel_political_1.name} (${formState.rel_political_1.relationship})`,
// 				fullWidth: true,
// 			});
// 			politicalArray.push({
// 				label: "Related PEP 1 — Position & Tenure",
// 				value: `${formState.rel_political_1.position} [${formState.rel_political_1.date_from} to ${formState.rel_political_1.date_to}]`,
// 				fullWidth: true,
// 			});
// 		}
// 		if (formState.rel_political_2?.name) {
// 			politicalArray.push({
// 				label: "Related PEP 2 — Name & Relationship",
// 				value: `${formState.rel_political_2.name} (${formState.rel_political_2.relationship})`,
// 				fullWidth: true,
// 			});
// 			politicalArray.push({
// 				label: "Related PEP 2 — Position & Tenure",
// 				value: `${formState.rel_political_2.position} [${formState.rel_political_2.date_from} to ${formState.rel_political_2.date_to}]`,
// 				fullWidth: true,
// 			});
// 		}
// 	}
// 	p4Sections += compileBlock("5.2 PEP Declaration", politicalArray);

// 	const filteredTickers = Array.isArray(formState.excluded_stocks)
// 		? formState.excluded_stocks.filter(Boolean).join(", ")
// 		: "";
// 	p4Sections += compileBlock("5.3 Trading Preferences", [
// 		{ label: "Exclude Specific Stocks?", value: formState.exclude_stocks },
// 		{
// 			label: "Excluded Stock Tickers",
// 			value:
// 				formState.exclude_stocks === "Yes" ? filteredTickers || "None" : "N/A",
// 			fullWidth: true,
// 		},
// 		{ label: "Portfolio Mandate", value: formState.portfolio_mandate },
// 	]);

// 	let page5 = createPageHTML(
// 		"Compliance",
// 		"Minor Account, PEP Declaration & Trading Preferences",
// 		p4Sections,
// 		compliancePageNum,
// 		totalDocumentPages,
// 	);

// 	// ── Page 6: Declaration & Documents ──────────────────────────────────────
// 	const executionPageNum = 5 + jointPageOffset;
// 	let p5Sections = compileBlock("6.1 Declaration & Signatures", [
// 		{
// 			label: "ID Document",
...
// 		},
// 		{ label: "Applicant Name", value: formState.sign_name },
// 		{ label: "Date Signed", value: formState.sign_date },
// 		{
...
// 	// Document gallery
// 	const assetMap = [
// 		{ data: formState.passport_photo, tag: "Applicant Photo" },
// 		{ data: formState.signature, tag: "Applicant Signature" },
// 		{ data: formState.id_doc, tag: "Applicant ID Document" },
// 		{ data: formState.utility_bill, tag: "Applicant Proof of Address" },
// 		{ data: formState.joint?.passport_photo, tag: "Joint Applicant Photo" },
// 		{ data: formState.joint?.signature, tag: "Joint Applicant Signature" },
// 		{ data: formState.joint?.id_doc, tag: "Joint Applicant ID Document" },
// 		{
// 			data: formState.joint?.utility_bill,
// 			tag: "Joint Applicant Proof of Address",
// 		},
// 		{ data: formState.nok1?.passport_photo, tag: "Next of Kin 1 Photo" },
// 		{ data: formState.nok1?.id_doc, tag: "Next of Kin 1 ID Document" },
// 		{ data: formState.nok2?.passport_photo, tag: "Next of Kin 2 Photo" },
// 		{ data: formState.nok2?.id_doc, tag: "Next of Kin 2 ID Document" },
// 		{ data: formState.minor?.passport_photo, tag: "Minor's Photo" },
// 		{
// 			data: formState.minor?.birth_certificate,
// 			tag: "Minor's Birth Certificate",
// 		},
// 	];
...
// 	if (assetCount > 0) {
// 		p5Sections += `<div class="pdf-section">
//       <div class="pdf-section-title">6.2 Uploaded Documents</div>
//       <div class="pdf-gallery">${galleryHTML}</div>
//     </div>`;
// 	}
...
async function renderPDF(html) {
	...
	const browser = await puppeteer.launch({
		executablePath: isProduction
			? "/usr/bin/google-chrome-stable" // installed by your Dockerfile
			: "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome",
		headless: "new",
		args: [
			"--no-sandbox",
			"--disable-setuid-sandbox",
			"--disable-dev-shm-usage", // critical on fly.io — /dev/shm is tiny
			"--disable-gpu",
		],
	});
