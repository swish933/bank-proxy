...
function buildPdfHtml(formState) {
    ...
    <div class="nsl-acct-block">
	  ...
	  <div class="nsl-acct-row"><span class="nsl-acct-label">Initial Amount Deposited (N)</span><span class="nsl-acct-value">${formState.initial_amount || "N/A"}</span></div>
    </div>
  </div>`;
  ...
  <div class="static-section">
    ...
    <p class="static-para">The Client should exercise particular care in evaluating the risks involved and must decide whether, in the light of the assessed risks, investment is appropriate. Clients should be aware that many unforeseen events — including new and existing government policies, domestic and international political and economic events, and other events of force majeure (acts of God, war, riot, urban unrest, terrorism, epidemic, pandemic, natural disasters, etc.) — may cause sharp market and price fluctuations.</p>
    <p class="static-para">The Client should acknowledge and accept each of the risks listed below and accept that all these risks could lead to the loss of some or the entire value of the Client's investments.</p>
  </div>
  ...
  <div class="static-section">
    ...
    <p class="static-para">All securities investments risk the loss of capital. Many unforeseeable events, including actions by various government agencies, domestic and international political and economic events, and other events of force majeure (such as acts of God, war, riot, urban unrest, terrorism, epidemic, pandemic, or natural disasters), may cause sharp market and price fluctuations.</p>
    ...
    <p class="static-para">The potential for profit or loss from transactions in foreign currency-denominated securities will be affected by fluctuations in foreign exchange rates. Clients or companies that have assets or business operations across national borders are exposed to currency risk that may create unpredictable profits and losses.</p>
    <p class="static-para"><strong>4. Execution Risk</strong></p>
    <p class="static-para">Nigerian Stockbrokers Limited, acting as broker, may on certain occasions be unable to execute the purchase or sale of securities in accordance with the Client's instruction. These occasions include, amongst other things, unfavourable market conditions, unmatched orders, or limitations imposed by the Exchange or other competent authorities.</p>
    <p class="static-para"><strong>5. Commission, Fees, Interest and Other Charges</strong></p>
    <p class="static-para">All regulatory fees, commissions, and charges are as approved by the regulatory authorities. The Client should obtain a clear explanation of all commissions, fees, interest and charges, and understand that these charges may affect the Client's net profit (if any) or increase the Client's loss. The Client agrees to be liable for these charges as may be amended from time to time.</p>
  ...
  <div class="static-section">
    ...
    <p class="static-para">Debt Securities and debt-linked investments offer fixed returns over a defined period and may be intended to be held to maturity. These instruments carry a significant amount of risk, including credit, currency and liquidity risks.</p>
    <p class="static-para">Credit risk in debt securities arises from default events that may result in the inability of the issuer to pay interest or principal. Default risk is high when the credit rating is non-investment grade or non-rated. In a default situation, the Client may lose both interest and principal.</p>
  </div>
  ...
  <div class="static-section">
    ...
    <p class="static-para">ETFs are exposed to the economic, political, currency, legal, tax and other risks of a specific factor or market related to the ETF or the index and market that it is tracking.</p>
    <p class="static-para"><strong>2. Currency Risk</strong></p>
    <p class="static-para">Clients will encounter currency risk where the ETF's underlying holdings are denominated in a currency different from the ETF's own denominated currency.</p>
    <p class="static-para"><strong>3. Liquidity Risk</strong></p>
    <p class="static-para">ETFs usually have market makers to provide liquidity; however, there is no guarantee that active trading will be maintained at all times. Where market makers are unable to fulfil their obligations, Clients may be unable to buy or sell the ETF, increasing the risk of loss.</p>
    ...
    <p class="static-para">A disparity between the performance of the ETF as measured by its NAV and the performance of the underlying index may occur due to factors such as the failure of the ETF's tracking strategy, fees and expenses, foreign exchange differences, or corporate actions of the ETF. The ETF's NAV may outperform or underperform the underlying index.</p>
    <p class="static-para"><strong>6. Index Risk</strong></p>
    <p class="static-para">ETFs are not actively managed; therefore, a security will not be sold where the issuer is in financial trouble unless the security is removed from the index. Investors are advised to understand the index and the rules governing it.</p>
    <p class="static-para"><strong>7. Risks of Trading at a Discount or Premium</strong></p>
    <p class="static-para">The trading price of an ETF is determined by supply and demand during periods of market volatility and uncertainty. Clients that buy at a premium may suffer losses even if the NAV is higher when they sell, and may not fully recover their investment in the event of ETF termination.</p>
  </div>`;
  ...
  <div class="static-section">
    ...
    <p class="static-para">Clients trading exchange traded derivatives products with underlying assets in other currencies are exposed to exchange rate risk. Currency rate fluctuations can adversely affect the underlying asset value and thus the exchange traded product price.</p>
    <p class="static-para"><strong>3. Expiry Considerations</strong></p>
    <p class="static-para">Most exchange traded derivatives products have an expiry date after which the product may become worthless. Clients should be aware of the expiry period and choose a product with an appropriate lifespan for their trading strategy.</p>
    <p class="static-para"><strong>4. Gearing Risk</strong></p>
    <p class="static-para">Exchange traded derivatives products are leveraged and can change in value rapidly according to the gearing ratio relative to the underlying assets. The value of an exchange traded product may fall to zero, resulting in a total loss of the initial investment.</p>
    <p class="static-para"><strong>5. Issuer Default Risk</strong></p>
    <p class="static-para">Where an exchange traded derivatives product issuer becomes insolvent and defaults on their listed securities, Clients will be considered as unsecured creditors and will have no preferential claims to any assets held by the issuer. Clients should thoroughly review the financial strength and creditworthiness of product issuers.</p>
    <p class="static-para"><strong>6. Uncollateralized Product Risk</strong></p>
    <p class="static-para">Uncollateralized exchange traded derivatives products are not asset-backed. In the event of issuer bankruptcy, Clients can lose their entire investment. Clients should read the listing documents to determine if a product is uncollateralized.</p>
  </div>

  <div class="static-section">
    <div class="static-section-title">E. Risk of Margin Trading (e.g. Share Margin Financing)</div>
    <p class="static-para">The risk of loss in financing a transaction by deposit of collateral may be significant. The Client may sustain losses in excess of their cash and any other assets deposited as collateral. The Client may be called upon at short notice to make additional margin deposits or interest payments. If the required margin deposit or interest payment is not made within the prescribed time, the Client's collateral or positions may be liquidated at a loss without prior notification. Clients should carefully consider whether such a financing arrangement is suitable given their financial position and investment objectives.</p>
  </div>

  <div class="static-section">
    <div class="static-section-title">F. Securities Borrowing and Lending</div>
    <p class="static-para">When the Client borrows securities, a required level of collateral must be deposited. The Client may be called upon at short notice to place additional deposits if the level of collateral is inadequate in relation to the market value of borrowed securities. If the required deposit is not made within the prescribed time, the firm may buy back the borrowed securities without prior notification to the Client.</p>
    <p class="static-para">When the Client lends securities to the firm, the Client temporarily loses legal ownership rights to the securities but retains the right to claim equivalent securities and dividends.</p>
  </div>`;
  ...
  <div class="static-section">
    ...
    <p class="static-para">Each decision by a Client to invest in securities is their own independent decision. The firm is not acting as an advisor. Before making a decision to invest, Clients should have carefully studied all information relating to the issuing entity, its financial condition and operations, underlying assets, as well as relevant political, economic, legal and regulatory conditions, and market demand and supply factors. As a result, the Clients bear all risks arising from the investment.</p>
  </div>

  <div class="static-section">
    <div class="static-section-title">H. Regulatory Risk</div>
    <p class="static-para">Nigerian Stockbrokers Limited is subject to the various laws and regulations of the competent relevant regulatory authorities. Any legislative or regulatory changes may impact the functions of the broker/dealer. All transactions performed by Nigerian Stockbrokers Limited will be executed in accordance with the relevant rules and regulations, and any that fall contrary to the existing regulatory framework may be nullified by the regulatory authorities.</p>
  </div>

  <div class="static-section">
    <div class="static-section-title">I. Non-Advisory Nature of Relationship</div>
    <p class="static-para">Unless the Client has a specific agreement with Nigerian Stockbrokers Limited for the provision of advisory or fund management services, the relationship between the Client and Nigerian Stockbrokers Limited in relation to securities transactions is purely execution only.</p>
    <p class="static-para">Whilst the firm will exercise all due care and skill in carrying out capital market services on behalf of the Client, all final investment decisions are taken by the Client and not the firm. Nigerian Stockbrokers Limited merely acts in a non-advisory capacity and executes orders on behalf of the Client unless otherwise specifically stated.</p>
  </div>

  <div class="static-section">
    <div class="static-section-title">J. Risk Relating to Digital Trading</div>
    <p class="static-para">A Client may elect to trade electronically through the broker's platform on their own account, thereby taking responsibility for their own actions. Trading via digital channels is subject to certain risks including, but not limited to, technological glitches, time-lag between order entry and real execution due to delayed transmission, password compromise, viruses and other harmful elements that could corrupt, compromise or impede the operation of a computer system or network. Clients should review the terms of service applicable to any online service they wish to subscribe to.</p>
    <p class="static-para">Clients should also maintain appropriate security measures in the operation of their online accounts, including using strong passwords, keeping login details confidential, avoiding login from public computers, and keeping their computers protected from viruses.</p>
  </div>`;
